...
var Language = class {
  ...
  */
  constructor(data, parser9, extraExtensions = [], name2 = "") {
    this.data = data;
    this.name = name2;
...
var LRLanguage = class _LRLanguage extends Language {
  constructor(data, parser9, name2) {
    super(data, parser9, [], name2);
    this.parser = parser9;
  }
  /**
...
var TokenCache = class {
  ...
  addActions(stack, token, end, index) {
    let { state } = stack, { parser: parser9 } = stack.p, { data } = parser9;
...
var Parse = class {
  constructor(parser9, input, fragments, ranges) {
    ...
    this.fragments = fragments.length && this.stream.end - from > parser9.bufferLength * 4 ? new FragmentCursor2(fragments, parser9.nodeSet) : null;
  }
  get parsedPos() {
  ...
  advanceStack(stack, stacks, split) {
    ...
    if (this.fragments) {
      ...
      for (let cached = this.fragments.nodeAt(start); cached; ) {
        ...
        if (match > -1 && cached.length && (!strictCx || (cached.prop(NodeProp.contextHash) || 0) == cxHash)) {
          ...
          if (verbose)
            console.log(base2 + this.stackID(stack) + ` (via reuse of ${parser9.getName(cached.type.id)})`);
          return true;
        }
    ...
    if (defaultReduce > 0) {
      ...
      if (verbose)
        console.log(base2 + this.stackID(stack) + ` (via always-reduce ${parser9.getName(
          defaultReduce & 65535
          /* Action.ValueMask */
        )})`);
      return true;
    ...
    for (let i = 0; i < actions.length; ) {
      ...
      if (verbose)
        console.log(base2 + this.stackID(localStack) + ` (via ${(action & 65536) == 0 ? "shift" : `reduce of ${parser9.getName(
          action & 65535
          /* Action.ValueMask */
...
var spec_identifier2 = { __proto__: null, to: 223 };
var parser2 = LRParser.deserialize({
  ...
  specialized: [{ term: 137, get: (value) => spec_callee[value] || -1 }, { term: 138, get: (value) => spec_queryIdentifier[value] || -1 }, { term: 4, get: (value) => spec_QueryCallee[value] || -1 }, { term: 28, get: (value) => spec_AtKeyword[value] || -1 }, { term: 136, get: (value) => spec_identifier2[value] || -1 }],
  tokenPrec: 2256
});
...
var indentation2 = new ContextTracker({
  ...
  shift(context, term, stack, input) {
    ...
    if (term == BlockLiteralHeader) {
      ...
      if (indent2) return new Context2(context, context.depth + +indent2[0], type_Lit);
    }
    return context;
  },
  hash(context) {
...
var JAVASCRIPT_EXTS = /* @__PURE__ */ new Set(["js", "mjs", "cjs", "jsx"]);
var TYPESCRIPT_EXTS = /* @__PURE__ */ new Set(["ts", "tsx"]);
var CPP_EXTS = /* @__PURE__ */ new Set(["c", "h", "cpp", "hpp"]);
...
var JSON_EXTS = /* @__PURE__ */ new Set(["json"]);
var YAML_EXTS = /* @__PURE__ */ new Set(["yaml", "yml"]);
var MEDIA_EXTENSIONS = [...IMAGE_EXTS, ...AUDIO_EXTS, ...VIDEO_EXTS];
var TEXT_EXTENSIONS = [
  "js",
  "mjs",
  "cjs",
...
function openWithSystemApp(app, file) {
  ...
  if (typeof adapter.getBasePath !== "function") {
    new import_obsidian.Notice("View Plus: system app opening is only available on desktop.");
    return;
  }
  const absPath = (0, import_path.join)(adapter.getBasePath(), file.path);
  const { shell } = require("electron");
  shell.openPath(absPath).then((err) => {
    if (err) {
      console.error("View Plus: openPath failed", err);
      new import_obsidian.Notice(`View Plus: could not open file - ${err}`);
    }
  });
}
var FileViewerView = class extends import_obsidian.TextFileView {
  constructor(leaf) {
    super(leaf);
  ...
  getDisplayText() {
    var _a2, _b;
    return (_b = (_a2 = this.file) == null ? void 0 : _a2.name) != null ? _b : "View Plus";
  }
  getViewData() {
    var _a2, _b;
    return (_b = (_a2 = this.editorView) == null ? void 0 : _a2.state.doc.toString()) != null ? _b : this.data;
  }
...
var MediaView = class extends import_obsidian.FileView {
  constructor(leaf) {
    super(leaf);
    this.addAction("external-link", "Open with system app", () => {
      if (this.file) {
  ...
  getIcon() {
    var _a2, _b, _c;
    const ext = (_c = (_b = (_a2 = this.file) == null ? void 0 : _a2.extension) == null ? void 0 : _b.toLowerCase()) != null ? _c : "";
...
function getLanguageExtensions(file) {
  if (!file) return [];
...
// src/main.ts
var ViewPlusPlugin = class extends import_obsidian2.Plugin {
  async onload() {
...
function safeRegisterExtensions(plugin, extensions, viewType) {
...
function isExternallyOpenableFile(file) {
  return file instanceof import_obsidian2.TFile && file.extension.toLowerCase() !== "md";
}
